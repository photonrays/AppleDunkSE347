...
function TsktTable({tongleState, demoProduct, template}) {
    useEffect(()=>{
    ...
    return (
        ...
        :( template === 1 ?  "hidden" : "lg:flex-1 lg:border-[2px] lg:border-slate-300 lg:boder-solid lg:p-[16px] lg:rounded-[7px] mx-[10px] tskt")}>
        <div className={template === 1 ? "hidden" : "font-bold text-[24px] mb-[10px]"}>Thông số kỹ thuật</div>
